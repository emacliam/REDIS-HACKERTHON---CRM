            ...
            >
                ...
                <div class="flex mt-4 sm:mt-0 sm:ml-4">
                    <Modal
                        ...
                        @post="POST_ISSUE()"
                    >
                        <form action="" class="w-[430px] mb-4 space-y-2">
                            <div>
                                <label
...
export default {
    ...
    setup() {
        ...
        onMounted(() => {
            ...
            FETCH_DASHBOARD(store.getters['auth/user'].pk)
            socket.on('connect', () => {
        ...
        async function FETCH_DASHBOARD(id) {
            try {
                loading.value = true
                const response = await DashboardService.getAll(id)
